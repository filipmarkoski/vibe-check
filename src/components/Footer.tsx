    ...
    <footer className="bg-gray-900 text-gray-300 py-10 mt-auto">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Information */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-3">Vibe Check</h3>
            <p className="mb-4">
              Your ultimate aggregator for discovering the best products across the web.
            </p>
            <p>© 2025 Vibe Check. All rights reserved.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/products/featured" className="hover:text-white transition-colors">
                  Featured Items
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/products/popular" className="hover:text-white transition-colors">
                  Popular Choices
                </Link>
              </li>
            </ul>
